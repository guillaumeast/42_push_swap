...
⚠️ `1 0 2 3`		=> BEST => swaps (1) = `1`			| lis (4) = `0 1 2 3`		| 🐛 
⚠️ `1 0 3 2`		=> BEST => swaps (2) = `1 3`		| lis (4) = `0 1 2 3`		| 🐛 
⚠️ `1 2 0 3`		=> BEST => swaps (1) = `0`			| lis (4) = `0 1 2 3`		| 🐛 
⚠️ `1 2 3 0`		=> BEST => swaps (0)				| lis (4) = `0 1 2 3`		| 🐛 
⚠️ `1 3 0 2`		=> BEST => swaps (1) = `2`			| lis (4) = `0 1 2 3`		| 🐛 
⚠️ `1 3 2 0`		=> BEST => swaps (1) = `3`			| lis (4) = `0 1 2 3`		| 🐛 

⚠️ `2 0 1 3`		=> BEST => swaps (1) = `3`			| lis (4) = `0 1 2 3`		| 🐛 
⚠️ `2 0 3 1`		=> BEST => swaps (1) = `0`			| lis (4) = `0 1 2 3`		| 🐛 
⚠️ `2 1 0 3`		=> BEST => swaps (2) = `2 3`		| lis (4) = `0 1 2 3`		| 🐛 
⚠️ `2 1 3 0`		=> BEST => swaps (1) = `2`			| lis (4) = `0 1 2 3`		| 🐛 
⚠️ `2 3 0 1`		=> BEST => swaps (0)				| lis (4) = `0 1 2 3`		| 🐛 
⚠️ `2 3 1 0`		=> BEST => swaps (1) = `1`			| lis (4) = `0 1 2 3`		| 🐛 

⚠️ `3 0 1 2`		=> BEST => swaps (0)				| lis (4) = `0 1 2 3`		| 🐛 
⚠️ `3 0 2 1`		=> BEST => swaps (1) = `2`			| lis (4) = `0 1 2 3`		| 🐛 
⚠️ `3 1 0 2`		=> BEST => swaps (1) = `1`			| lis (4) = `0 1 2 3`		| 🐛 
⚠️ `3 1 2 0`		=> BEST => swaps (1) = `0`			| lis (4) = `0 1 2 3`		| 🐛 
⚠️ `3 2 0 1`		=> BEST => swaps (1) = `3`			| lis (4) = `0 1 2 3`		| 🐛 
⚠️ `3 2 1 0`		=> BEST => swaps (1) = `3 1`		| lis (4) = `0 1 2 3`		| 🐛 
